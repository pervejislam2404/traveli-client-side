        ...
        div className = "container mx-auto bg-light row py-5 g-4" > {
            added ? .map((item, index) => {
                return ( <
                    ...
                    <
                    Card.Text className = "fw-light text-muted" > { item ? .description } <
                    /Card.Text>

                    <
                    Button className = "text-primary my-2 fw-bold"
                    variant = "light" > booked in { item ? .booked } < /Button>
                    ...
                    variant = "danger text-white " > < i class = "fas fa-trash-alt px-2" > < /i>Delete</Button >
                    <
                    /div>
